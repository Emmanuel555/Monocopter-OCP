...
class sort_traj_data(object):
    ...
    def train_circle5(self,folder): # only for indi
        # circle 0.3
        #indi3 = '/home/emmanuel/Monocopter-OCP/paper_plots/' + folder + '/circle3/indi/'
       
        indi5 = '/home/emmanuel/Monocopter-OCP/RL/' + folder + '/circle5/indi/'    
        indi5 = self.traj_compile.normal_data_compiler(indi5)
        return (indi5)
