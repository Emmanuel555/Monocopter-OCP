...
if selected_wing == short_wing:
    title = 'MPC tracking performance using short-wing'
elif selected_wing == long_wing:
    title = 'MPC tracking performance using long-wing'
elif selected_wing == foam_wing:
    title = 'MPC tracking performance using ultralight-wing'
...
for i in range(paper_size[0]):
    for j in range(paper_size[1]):
        ...
        paper_rmse[i][j] = statistics.mean(xyz_rmse[j][i])        
