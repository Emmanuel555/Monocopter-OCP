...
## generate the plot
""" fig, ((ax1,ax3,ax5,ax7,ax9,ax11),(ax2,ax4,ax6,ax8,ax10,ax12)) = plt.subplots(2, 6, figsize=(40, 12))
...
fig, ((ax1,ax7,ax13,ax19,ax25,ax31),(ax2,ax8,ax14,ax20,ax26,ax32),
      ...
      (ax5,ax11,ax17,ax23,ax29,ax35),(ax6,ax12,ax18,ax24,ax30,ax36)) = plt.subplots(6, 6, figsize=(40, 12))
graphs = [[ax1,ax2,ax3,ax4,ax5,ax6],[ax7,ax8,ax9,ax10,ax11,ax12],[ax13,ax14,ax15,ax16,ax17,ax18],
          [ax19,ax20,ax21,ax22,ax23,ax24],[ax25,ax26,ax27,ax28,ax29,ax30],[ax31,ax2,ax33,ax34,ax35,ax36]]
#colors = ['#254abe','#96400b','#a725be','#254abe','#96400b','#a725be']
colors = ['#254abe','#254abe','#96400b','#96400b''#254abe','#96400b']
#med_colors = ['#34be25','#34be25','red','#34be25','#34be25','red']
med_colors = ['#34be25','#34be25','red','red','#34be25','red']
