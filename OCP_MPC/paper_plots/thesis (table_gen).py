...
if selected_wing == short_wing:
    title = 'Tracking performance using short-wing'
elif selected_wing == long_wing:
    title = 'Tracking performance using long-wing'
elif selected_wing == foam_wing:
    title = 'Tracking performance using ultralight-wing'
...
if selected_wing == foam_wing:
    ## generate the plot
    fig, ((ax1,ax5),(ax2,ax6),
        (ax3,ax7),(ax4,ax8)) = plt.subplots(4, 2, figsize=(40, 60))
    ...
    fig, ((ax1,ax7,ax13,ax19,ax25,ax31),(ax2,ax8,ax14,ax20,ax26,ax32),
        ...
        (ax5,ax11,ax17,ax23,ax29,ax35),(ax6,ax12,ax18,ax24,ax30,ax36)) = plt.subplots(6, 6, figsize=(40, 60))
        ...
        for m in range(len(graphs[a])): # 0.4 all methods  
            ...
            if order == '(Pos)':
                for i in range(3): #xyz
                    ...
                    # add title
                    graphs[a][m].set_title(traj_label + method_label + order, fontsize=43, fontweight='bold')
