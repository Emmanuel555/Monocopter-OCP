...
pva,num_pts = traj_gen.boomerang_teardrop(1.0, 1.0, laps=2, pid_update_rate=250, reverse_cw=0, speedX=5, alt=alt)
...
ax.plot(pos_x, pos_y, label='teardrop', color='blue')
#ax.plot(t, pos_z, label='lemniscate', color='blue')
#ax.set_title('Derivatives gen', fontsize=20)
ax.set_title('teardrop', fontsize=20)
ax.legend()
