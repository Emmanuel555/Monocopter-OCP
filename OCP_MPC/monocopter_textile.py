...
class Monocopter_textile(object):
    ...
    def __init__(self, noisy=False, drag=False, payload=False, motor_noise=False):
        ...
        self.max_thrust = 20 # lol not so high la cb
        #self.motor_coeff_downsize = 0.75
        self.motor_coeff_downsize = 0.0765
    ...
    def set_state(self, *args, **kwargs):
        if len(args) != 0:
            ...
            self.a_rate[0], self.a_rate[1], self.a_rate[2] \
                = args[0] # this is where the arg from self.x are appended...
