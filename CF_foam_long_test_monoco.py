...
if __name__ == '__main__':
    ...
    # circle parameters
    radius = 0.75 # 0.5
    speedX = 4.0 # 0.5 m/s the best thus far
    laps = 3
    leminiscate_laps = 4
    ...
    #pva,num_pts = traj_gen.compute_jerk_snap_9pt_elevated_circle_x_laps(x_offset, y_offset, elevated_radius, speedX, max_sample_rate/pid_loop,laps,reverse_cw,elevated_alt)
...
# save data
path = '/home/emmanuel/Monocopter-OCP/DFBC/payload_DFBC_' + monoco_name + chosen_traj + str(speedX*0.1) + '_ms'
