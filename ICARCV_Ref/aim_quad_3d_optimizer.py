...
class Quad3DOptimizer:
    def __init__(self, quad, t_horizon=1, n_nodes=20,
                 ...
                 model_name="quad_3d_acados_mpc", solver_options=None): # insert one more argument here to show that I am using the ith iterated gp...
        """
    ...
    def acados_setup_model(self, nominal, model_name):
        ...
        if self.gp_reg_ensemble is not None:
            ...
            acados_models[0] = fill_in_acados_model(x=x_, u=self.u, p=[], dynamics=dynamics_, name=model_name) # dict
    ...
    def run_optimization(self, initial_state=None, use_model=0, return_x=False, gp_regression_state=None):
        ...
        for i in range(self.N):
            w_opt_acados[i, :] = self.acados_ocp_solver[use_model].get(i, "u") # thrusters x 4 
            x_opt_acados[i + 1, :] = self.acados_ocp_solver[use_model].get(i + 1, "x") # angular bodyrates input
